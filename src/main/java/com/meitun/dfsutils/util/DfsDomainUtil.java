...
public class DfsDomainUtil {
	 ...
	 *            图片url:如
	 *            group1/M00/00/0B/rBABm1S7nbqAMcK8AE6PY3fCE94253_640.jpg
	 * @return  支持https的返回，如果图片域名配置不以http://或https://开头的话 将返回       //img03.elsa.com/group1/M00/00/
	...
	static Map<String, String> getMap() {
		...
		domainMap.put("group1", "http://img01.elsa.local/,http://img02.elsa.local/,http://img03.elsa.local/,http://img04.elsa.local/");
		domainMap.put("group2", "http://img02.elsa.local/");
		return domainMap;
	}
